...
public class ProjectManagmentApplication {
	//remember we can inject a dependency into this class
...
// The code below shows how to fill the DB manually
// Best used with the H2 database
//	@Bean
//	CommandLineRunner runner() {
//		return args -> {
////			 the args get passed from the main driver method abovez
...
////			 need to set both sides of the relationship manually
//
//			emp1.setCurrentProject(Arrays.asList(pro1, pro3, pro4));
//			emp2.setCurrentProject(Arrays.asList(pro1));
//			emp3.setCurrentProject(Arrays.asList(pro2, pro4));
//			
